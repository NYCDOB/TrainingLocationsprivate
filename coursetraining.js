						...
						if ( allCoursesFiltered )  {
							...
							for (let i=0, totRows=vCoursesTable.rows.length; i < totRows; i++ ) {
									...
									if ( vCoursesTable.rows[i].getAttribute("level")=="3" ) {	
										...
										if (vCourses.has(vCoursesTable.rows[i].getAttribute("parent-id").substring( vCoursesTable.rows[i].getAttribute("parent-id").indexOf("__"))) >-1 &&  vCoursesTable.rows[i].getAttribute("row-id").indexOf('__') >= 0 ) {
											  true; 
...
function buildTblTreeElements(data, keyArray, languages) {			
		...
		let alldata2 = keyArray.map(function(q, indexNum, array) {  //q=current element in array of keys
			...
			if ( !boroughlocationcoursedatetimestartentryset.has(q )){  //level 3  COURSE DATE/TIME
						...
						let newRow =tableRef.insertRow(-1);let newCell = newRow.insertCell(0);let newSpan1 = document.createElement("span");let newText1 = document.createTextNode("Date/Time:");
						...
						let newText2 = document.createTextNode(d["Start Date"]+" " + d["Start Time"] + ((d["End Time"] ) ? " - "+d["End Time"]:" ")+  //end time is sometimes missing
								" (" + ((d.Instructor)? d.Instructor:"(tbd)") + ")");
						newSpan2.appendChild(newText2);newCell.appendChild(newSpan1);newCell.appendChild(newSpan2);newRow.setAttribute("row-id",q);
						...
						if  ( indexNum == array.length-1 || (q.substr(0,9) !=  array[indexNum+1].substr(0,9))  ) {
							let newRow =tableRef.insertRow(-1);let newCell = newRow.insertCell(0);let newSpan1 = document.createElement("span");let newText1 = document.createTextNode("Provider:");
							newSpan1.appendChild(newText1);newSpan1.classList.add("detailHead");let newSpan2 = document.createElement("span");let newText2 = document.createTextNode(d["Course Provider"]);
							...
							newRow.setAttribute("parent-id",d.Borough+"__"+d.TrainingLocationID+"__"+d.CourseID);newRow.className="providerInfo";newRow.id=q+"__provider";
							newRow =tableRef.insertRow(-1);newCell = newRow.insertCell(0);newSpan1 = document.createElement("span");newText1 = document.createTextNode("Web:");
							newSpan1.appendChild(newText1);newSpan1.classList.add("detailHead");newSpan2 = document.createElement("span");
							let newA = document.createElement("a");newText2 = document.createTextNode(d["CourseProviderWebsite"]);newA.target="_blank";
							newA.href=d["CourseProviderWebsite"];newA.appendChild(newText2);newSpan2.appendChild(newA);newCell.appendChild(newSpan1);
							newCell.appendChild(newSpan2);newRow.setAttribute("row-id",q+"__website");newRow.setAttribute("parent-id",d.Borough+"__"+d.TrainingLocationID+"__"+d.CourseID);
							newRow.className="providerInfo";newRow.id=q+"__website";newRow =tableRef.insertRow(-1);newCell = newRow.insertCell(0);newSpan1 = document.createElement("span");
							newText1 = document.createTextNode("Phone:");newSpan1.appendChild(newText1);newSpan1.classList.add("detailHead");newSpan2 = document.createElement("span");
							newText2 = document.createTextNode(d["CourseProviderPhone"]);newSpan2.appendChild(newText2);newCell.appendChild(newSpan1);newCell.appendChild(newSpan2);								
							newRow.setAttribute("row-id",q+"__phone");newRow.setAttribute("parent-id",d.Borough+"__"+d.TrainingLocationID+"__"+d.CourseID);newRow.className="providerInfo";
							newRow.id=q+"__phone";newRow =tableRef.insertRow(-1);newCell = newRow.insertCell(0);newSpan1 = document.createElement("span");newText1 = document.createTextNode("Price:");
							newSpan1.appendChild(newText1);newSpan1.classList.add("detailHead");newSpan2 = document.createElement("span");newText2 = document.createTextNode(d["Price"]);
							newSpan2.appendChild(newText2);	newCell.appendChild(newSpan1);newCell.appendChild(newSpan2);newRow.setAttribute("row-id",q+"__price");newRow.setAttribute("parent-id",d.Borough+"__"+d.TrainingLocationID+"__"+d.CourseID);
